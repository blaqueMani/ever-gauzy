...
import { IIntegrationEntitySetting, IPagination } from '@leano/contracts';
...
export class IntegrationEntitySettingGetHandler
	implements ICommandHandler<IntegrationEntitySettingGetCommand> {
